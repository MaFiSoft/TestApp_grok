// Timestamp: 2025-05-22 22:30:00 CEST
// /app/build.gradle.kts
plugins {
 id("com.android.application") version "8.7.1" // Aktualisiert von 8.7.0
...
android {
 ...
 composeOptions {
 kotlinCompilerExtensionVersion = "1.5.20" // Aktualisiert von 1.5.18
 }
}
